...
All three adapters follow the same pattern for integrating with the [Unit of Work](/docs/domain-configuration/unit-of-work):
...
- [Unit of Work](/docs/domain-configuration/unit-of-work) — How atomic persistence and deferred event publishing work
- [Example: Fund Transfer](/docs/patterns/fund-transfer) — Atomic multi-command operations using `withUnitOfWork()`
