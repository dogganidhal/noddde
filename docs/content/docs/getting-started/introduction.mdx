...
`defineDomain` captures the domain structure and `wireDomain` connects it to adapters to create a running domain:
...
| Ports             | Decorator-based injection         | Function parameter injection                 |
