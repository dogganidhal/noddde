...
- [Testing Aggregates](/docs/testing/testing-aggregates) — `testAggregate` and `evolveAggregate` in depth
- [Testing Projections](/docs/testing/testing-projections) — `testProjection` patterns
