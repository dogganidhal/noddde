...
const view = domain.getProjectionView<{ balance: number }>("BankAccountView");
...
- [Testing Aggregates and Projections](/docs/testing/testing-aggregates-and-projections) -- Unit-level aggregate and projection testing
- [Testing Sagas](/docs/testing/testing-sagas) -- Unit-level saga testing
- [Domain Configuration](/docs/running/domain-configuration) -- Full `configureDomain` reference
