...
description: Using testAggregate, evolveAggregate, and testProjection for Given-When-Then testing of command handlers and read models.
---
...
const result = await testAggregate(BankAccount)
  ...
  .when({
    ...
    targetAggregateId: "acc-1",
    payload: { transactions: [{ amount: 100 }, { amount: 200 }, { amount: 300 }] },
  })
  .execute();
...
const result = await testProjection(BankAccountProjection)
  .given(
    { name: "BankAccountCreated", payload: { id: "acc-1" } },
    { name: "DepositMade", payload: { amount: 1000 } },
    { name: "TransactionAuthorized", payload: { id: "t1", amount: 200, merchant: "Store", timestamp: now } },
    { name: "TransactionProcessed", payload: { id: "t1", amount: 200, merchant: "Store", timestamp: now } },
  )
  .execute();
