...
- **Ports injection** — Dependencies are function parameters, not imports; testable by default
...
- [Why Injectable Ports?](/docs/design-decisions/why-injectable-ports) — Testability by design
