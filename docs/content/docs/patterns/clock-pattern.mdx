...
description: How to inject time as an infrastructure dependency for deterministic, testable command handlers.
---
...
- [Custom Infrastructure](/docs/infrastructure/custom-infrastructure) — Defining infrastructure types
- [Testing Infrastructure](/docs/testing/testing-infrastructure) — Full testing patterns
