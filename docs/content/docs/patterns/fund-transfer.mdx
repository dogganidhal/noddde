...
This example walks through the fund transfer sample included with noddde. It demonstrates the [Unit of Work](/docs/running/unit-of-work) pattern for grouping multiple commands into a single atomic boundary — both succeed or neither takes effect.
...
- [Unit of Work](/docs/running/unit-of-work) — Full reference for `withUnitOfWork()` and the `UnitOfWork` interface
