...
<Callout type="info">
  You can scaffold this entire structure with the CLI: `noddde new aggregate BankAccount`. See [CLI Reference](/docs/getting-started/cli#noddde-new-aggregate-name) for details.
</Callout>
