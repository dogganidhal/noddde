...
- [Drizzle Adapter](/docs/persistence/drizzle) -- TypeScript table builders, per-dialect setup, and transaction integration
- [Prisma Adapter](/docs/persistence/prisma) -- `.prisma` schema, generated client, and adapter wiring
- [TypeORM Adapter](/docs/persistence/typeorm) -- Decorator entities and MSSQL support
