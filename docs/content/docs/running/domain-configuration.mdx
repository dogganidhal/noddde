...
<Callout type="info">
  You can scaffold a full project with `noddde new project my-app`, or add a domain layer to an existing project with `noddde new domain my-domain`. See [CLI Reference](/docs/getting-started/cli) for details.
</Callout>
