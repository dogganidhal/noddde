...
Provides the factory for creating `UnitOfWork` instances used for atomic command dispatch. See [Unit of Work](/docs/running/persistence#unit-of-work) for details.
