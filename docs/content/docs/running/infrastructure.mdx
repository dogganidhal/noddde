...
- [Logging](/docs/running/logging) -- The framework `Logger` interface injected into every handler
- [Observability](/docs/running/observability) -- Metrics, tracing, and operational visibility built on the infrastructure system
