...
- Define your own aggregates in the [Aggregates guide](/docs/guides/aggregates)
- Understand why noddde chose this pattern in [Why the Decider Pattern](/docs/design-decisions/why-decider)
- Learn how infrastructure injection works in detail in the [Domain Configuration guide](/docs/guides/domain-configuration)
