...
- [Defining Aggregates](/docs/aggregates/defining-aggregates) -- How to build the aggregate these helpers extract from
- [Command Routing](/docs/aggregates/command-routing) -- How `targetAggregateId` and custom ID types affect routing
- [Defining Queries](/docs/queries/defining-queries) -- Type-safe query definitions for the read side
