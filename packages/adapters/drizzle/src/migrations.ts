/**
 * Drizzle-Kit compatible migration SQL generation for noddde persistence tables.
 *
 ...
 * Can be written to a migration directory for `drizzle-kit push` or `drizzle-kit migrate`.
 *
...
export function generateDrizzleMigration(
  ...
  parts.push(`-- Generated by @noddde/drizzle for ${dialect}`);
  parts.push("");
